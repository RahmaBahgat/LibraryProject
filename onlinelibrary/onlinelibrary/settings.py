...
SECRET_KEY = 'django-insecure-0e*o=-u*+&w6&t7!a08uhmhs%ekm6m-dq9xq@$zoaj0dwm@k=u'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'onlinelibrary', 'Templates'),
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR.parent, 'onlinelibrary', 'Static'),
]
